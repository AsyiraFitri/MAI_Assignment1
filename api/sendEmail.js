...
import { v4 as uuidv4 } from 'uuid'; // Import the uuid package (if you choose to use it)
...
export default async function handler(req, res) {
  if (req.method === 'POST') {
    try {
      ...
      const requestId = uuidv4(); // Example: 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855'
